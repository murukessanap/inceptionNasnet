...
'''csv_logger = keras.callbacks.CSVLogger('logs/model_NASNetLarge_updated_training2.log')
...
check_pts = keras.callbacks.ModelCheckpoint("chkpts/model_NASNetLarge_updated2.h5", monitor='val_loss', save_best_only=True, verbose=1)
